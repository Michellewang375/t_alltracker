...
MASK_ALL_DIR = "./p01_left_preop_scope01/window1/fmap1"
ALLT_IMG_DIR = "./p01_left_preop_scope01/window1/masked1"
DB_PATH = "./p01_left_preop_scope01/window1/alltracker.db"
